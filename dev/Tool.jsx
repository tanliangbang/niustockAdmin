...
Tool.uploadImg = function(resolve, reject){
    $.ajaxFileUpload({
        url:'/api/bond/upload',
        secureuri:false,
        fileElementId:'attachment',//file标签的id
...
Tool.hasPower = function(userInfo,model,power){
...
Tool.hasModelPower = function(userInfo,model){
    if(userInfo.account=="admin"){
        return true;
    }
    var powers = JSON.parse(userInfo.powers);
