...
module.exports = {
    ...
    output: {
        ...
        filename: '../admin/js/[hash:8].[name].js'
    },
    resolve: { 
    ...
    plugins: [//将外部的包导出成一个公用的文件比如 jquery，react, react-dom 等
        ...
        new webpack.optimize.CommonsChunkPlugin('common','../admin/js/[hash:8].common.js'),
        ...
        new ExtractTextPlugin("../admin/css/[hash:8].styles.css"),
